    ...
    <div class="row quick-action-toolbar">
        <div class="col-md-12 grid-margin">
            <div class="card">
                ...
                <div class="row p-3">
                    <div class="col-md-3">
                        <form id="exportData" action="{{ url('teacher/export/data') }}" method="post">
                            @csrf
                        ...
                        <tbody id="tBody">
                            @if(count($teachers))
                                ...
                                @foreach($teachers as $teacher)
                                    <tr id="{{ $teacher->id }}">
                                        {{-- <td>{{ ++$count }}.</td> --}}
                                        <td><a href="{{ asset('storage/'.$teacher->profile) }}" target="_blank">
                    ...
                    <div class="float-right mr-3">
                        <nav>
                            <ul class="pagination">
                                ...
                                @for($i = 2; $i <= $totalTchr; $i++)
                                    <li class="page-item"><a class="page-link" href="#">{{ $i }}</a></li>
                                @endfor
                                <li class="page-item {{ ($totalTchr < 2) ? 'disabled' : '' }}"><a class="page-link" href="#">Next</a></li>
                            </ul>
                        </nav>
                    </div>
                </div>
